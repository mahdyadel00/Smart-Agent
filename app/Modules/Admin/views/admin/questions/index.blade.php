...
'title' => _i('All Questions'),
'activePageName' => _i('All Questions'),
'activePageUrl' => '',
'additionalPageUrl' => route('questions.create') ,
        ...
        <div class="row">
            ...
            <div class="col-sm-12 mb-3">
                <span class="pull-left">
                    <a href="{{ route('questions.create') }}" class="btn btn-primary create add-permissiont"
                        type="button"><span><i class="ti-plus"></i> {{ _i('create new Questions ') }} </span></a>
                </span>
            </div>
            @endcan
            <div class="col-sm-12">
