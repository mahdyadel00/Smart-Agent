    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{ _i('Create new Modules') }}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('modules.store') }}" method='post' id='add-form'>
                    @csrf
                    <div class="row">
                        <!-- ------------------------------------** Status **----------------------------------------------------- -->
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputOrder1">{{ _i('Video') }}</label>
                                <input type="file" class="form-control modal-title" name='video'>
                            </div>
                        <!-- ------------------------------------** Content Title **----------------------------------------------------- -->
                            <div class="form-group">
                                <label for="exampleInputOrder1">{{ _i('Content Title') }}</label>
                                <input type="text" class="form-control modal-title" name='content_title'>
                            </div>
                        </div>
                        <!-- ------------------------------------** Title **----------------------------------------------------- -->
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control modal-name " name='body'></textarea>
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="modal fade" id="default-Modal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{ _i('Edit Modules') }}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
